# from https://github.com/philtabor/Youtube-Code-Repository/blob/master/ReinforcementLearning/DeepQLearning/ddqn_keras.py
import numpy as np
...
class DDQNAgent(object):
    ...
    def choose_action_no_explore(self, state):
        state = state[np.newaxis, :]
        actions = self.q_eval.predict(state)
        action = np.argmax(actions)
        return action
